...
## 🎫 Ticketmaster Scraper Tutorial

For a real-world example, see [ticketmaster_scraper_congig_tutorial.md](ticketmaster_scraper_congig_tutorial.md). It covers the setup and commands for running the `ticketmaster_scraper.py` script:
...
## 🧪 Tests
Basic tests ensuring the example scripts run correctly are located under
`tests/`. They verify that utility functions and scrapers work with sample URLs
or JSON endpoints. Execute the suite with:
